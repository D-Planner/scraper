...
import adamProfile from '../../../assets/photos/adam-profile.jpg';
import benProfile from '../../../assets/photos/ben-profile.jpg';
import zirayProfile from '../../../assets/photos/ziray-profile.jpg';

const FACEBOOK_LINK = 'https://www.google.com';
const INSTAGRAM_LINK = 'https://www.google.com';
const TWITTER_LINK = 'https://www.google.com';
      ...
      return (
        <div className="landing-container" style={{ overflow: 'hidden' }}>
          <section className="landing-top mobile">
            ...
            <div className="landing-left full mobile" style={{ padding: '0 10vw' }}>
              <div className="intro">
                ...
                <div className="landing-subfeature-text-container" style={{ display: 'flex', alignContent: 'center', marginBottom: '4vw' }}>
                  <img className="landing-subfeature-icon" src={feature1} alt="subfeature-icon" style={{ height: '10vw', margin: 'auto 3vw auto 0' }} />
                  <p style={{ color: 'white', margin: 'auto' }}>Browse thousands of courses - full with student reviews, terms-offered predictions, and much more.</p>
                </div>
                <div className="landing-subfeature-text-container" style={{ display: 'flex', alignContent: 'center', marginBottom: '4vw' }}>
                  <img className="landing-subfeature-icon" src={feature2} alt="subfeature-icon" style={{ height: '10vw', margin: 'auto 3vw auto 0' }} />
                  <p style={{ color: 'white', margin: 'auto' }}>Build out academic plans that fit your needs. Test out different scenarios easily.</p>
                </div>
                <div className="landing-subfeature-text-container" style={{ display: 'flex', alignContent: 'center', marginBottom: '4vw' }}>
                  <img className="landing-subfeature-icon" src={feature3} alt="subfeature-icon" style={{ height: '10vw', margin: 'auto 3vw auto 0' }} />
                  <p style={{ color: 'white', margin: 'auto' }}>Visualize your undergraduate years at Dartmouth. Know exactly what you should take.</p>
                </div>
          ...
          <section className="landing-section colored mobile" style={{ padding: '10vw' }}>
            <div className="landing-feature vertical mobile">
              ...
              <div style={{ padding: '8vw' }}>
                <h3 className="dark">Keyword-based Course Search</h3>
                <p className="dark">Plan out your time at college, and feel confident in your course decisions! Plan out your time at college, and feel confident in your course decisions!</p>
              </div>
            </div>
          </section>
          ...
          <section className="landing-section mobile" style={{ padding: '10vw' }}>
            <div className="landing-feature vertical mobile colored">
              ...
              <div style={{ padding: '8vw' }}>
                ...
                <p>Plan out your time at college, and feel confident in your course decisions! Plan out your time at college, and feel confident in your course decisions!</p>
              </div>
            </div>
          </section>
          ...
          <section className="landing-section colored footer mobile" style={{ padding: '15vw 10vw' }}>
            <div style={{ marginBottom: '3vw' }}><a href="mailto:info@d-planner.com">Want to bring D-Planner to your school? Click here to let us know!</a></div>
            <div style={{ marginBottom: '3vw' }}><a href="mailto:info@d-planner.com" style={{ marginBottom: '10vw' }}>Are you a college administrator? We provide data analytics!</a></div>
            <div style={{ marginBottom: '3vw' }}><a href="/credits" style={{ marginBottom: '10vw' }}>We couldn’t have gotten here without many talented people. See our credits page!</a></div>
            <div style={{ marginBottom: '3vw' }}><a href="mailto:info@d-planner.com" style={{ marginBottom: '10vw' }}>Have a question that we haven’t answered? Click here to let us know!</a></div>
            <div className="landing-social-icon-container right"
              style={{
                width: '100%', display: 'flex', flexDirection: 'row', margin: '10vw auto auto', justifyContent: 'center',
              }}
            >
              <img src={facebookIcon}
                ...
                alt="facebook-link"
                style={{
                  width: '10%', height: 'auto', marginRight: '5%', cursor: 'pointer',
                }}
              />
            ...
            <h4 style={{
              color: 'white', margin: 'auto 0', textAlign: 'center', marginBottom: '8vw',
            }}
            >© 2020, D-Planner
            </h4>
            <div className="landing-icon-container" style={{ display: 'flex' }}>
              <div className="landing-social-icon-container left">
                <img src={dartmouthIcon} alt="dartmouth" style={{ width: '15vw' }} />
              </div>
              <h4 className="dark" style={{ color: 'white', margin: 'auto 0 auto 10vw' }}>Proudly built at Dartmouth College</h4>
            </div>
          </section>
        </div>
      );
